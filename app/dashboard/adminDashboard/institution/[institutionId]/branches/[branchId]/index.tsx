...
export default function BranchProfile() {
  ...
  const [branchStatus, setBranchStatus] = useState<"active" | "disabled">("active");
        ...
        {staffLoading ? (
          ...
          previewAdmins.map((admin: any) => (
            <TouchableOpacity
              ...
              onPress={() => {
                if (institutionId && admin._id) {
                  router.push({
                    pathname: "/dashboard/adminDashboard/institution/[institutionId]/admins/[staffId]",
                    params: { institutionId, staffId: admin._id },
                  });
                }
              }}
            >
        ...
        {staffLoading ? (
          ...
          previewStaff.map((staff: any) => (
            <TouchableOpacity
              ...
              onPress={() => {
                if (institutionId && branchId && staff._id) {
                  router.push({
                    pathname:
          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                if (institutionId && branchId) {
                  router.push(
                    `/dashboard/adminDashboard/institution/${institutionId}/branches/${branchId}/edit`
                  );
                }
              }}
            >
