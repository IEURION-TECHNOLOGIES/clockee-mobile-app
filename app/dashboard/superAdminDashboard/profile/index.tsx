      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.topHeader}>
          <View style={styles.profileRow}>
           <Image source={getAvatar()} style={styles.avatar} />
            <View style={{ flex: 1 }}>
              <Text style={styles.name}>{profile?.name || "Super Admin"}</Text>
              <Text style={styles.email}>
                {profile?.email || "superadmin@platform.ng"}
              </Text>

              <View style={styles.roleBadge}>
                <Text style={styles.roleText}>{profile?.role? "Super Admin": "No Role"}</Text>
              </View>
            </View>
        ...
        <Card>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push("/superAdmin/editProfile")}
          >
