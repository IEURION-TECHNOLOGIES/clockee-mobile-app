    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.profileRow}>
           <View style={styles.avatarContainer}>
            ...
            <View style={styles.roleBadge}>
              <Text style={styles.roleText}>{profile?.role? "Admin": "No Role"}</Text>
            </View>
          </View>
        </View>
        ...
        <Card>
          ...
          <InfoRow label="Institution Name" value={profile?.institutionName || "-"} />

          <TouchableOpacity
            style={styles.actionRow}
            onPress={() => router.push("/dashboard/adminDashboard/profile/edit")}
          >
