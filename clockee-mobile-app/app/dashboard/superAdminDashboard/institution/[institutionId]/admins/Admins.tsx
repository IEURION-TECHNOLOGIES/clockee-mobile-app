...
type Admin = {
  ...
  branch?: string;
  dashboardType?: "owner" | "superAdmin";
};
...
const fetchAdmins = async () => {
  try {
    ...
    const formatted: Admin[] = data.map((item: any) => ({
      ...
      dashboardType: item.dashboardType || "superAdmin",
    }));
        ...
        {filteredAdmins.map((admin) => (
          <AdminCard
            ...
            onCardPress={() =>
              router.push({
                pathname:
                  "/dashboard/ownerDashboard/institution/[institutionId]/admins/profile",
                params: {
                  institutionId,
      ...
      <View style={styles.adminLeft}>
        ...
        <View>
          ...
          <View style={styles.metaRow}>
            <Text style={styles.role}>{admin.dashboardType}</Text>
