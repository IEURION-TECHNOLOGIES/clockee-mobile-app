...
export default function NewInviteScreen() {
  ...
  const handleContinue = () => {
    ...
    switch (selected) {
      case "manual":
        router.push(
          `/dashboard/primaryAdminDashboard/institution/${institutionId}/branches/${branchId}/staff/create`
        );
        break;
      ...
      case "single":
        router.push(
          `/dashboard/primaryAdminDashboard/institution/${institutionId}/branches/${branchId}/staff/invites/single`
        );
        break;
