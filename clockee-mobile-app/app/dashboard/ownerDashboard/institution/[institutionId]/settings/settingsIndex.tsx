  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Item
        ...
        onPress={() =>
          router.push(
            `/dashboard/ownerDashboard/institution/${institutionId}/settings/edit`
          )
        }
      />
      ...
      <Item
        ...
        onPress={() =>
          router.push(
            `/dashboard/ownerDashboard/institution/${institutionId}/settings/preferences`
          )
        }
      />
      ...
      <Item
        ...
        onPress={() =>
          router.push(
            `/dashboard/ownerDashboard/institution/${institutionId}/settings/security`
          )
        }
      />
      ...
      <Item
        ...
        onPress={() =>
          router.push(
            `/dashboard/ownerDashboard/institution/${institutionId}/settings/audit`
          )
        }
      />
