...
import { createStaffByAdmin } from "@/services/superAdminServices";
...
export default function AssignInstitutionAdmin() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await createStaffByAdmin(payload);

      Alert.alert("Success", response?.data?.message || "Staff created successfully");
