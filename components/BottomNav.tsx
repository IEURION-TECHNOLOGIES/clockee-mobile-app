...
export default function BottomNav({ dashboardType }: BottomNavProps) {
  ...
  const SUPER_ADMIN_NAV: NavItem[] = [
    ...
    { 
      ...
      path: `${base}/institution/institutionList` 
    },
    { 
      key: "users", 
      match: "users", 
      label: "Users",
      icon: { type: "ion", name: "people-outline" }, 
      path: `${base}/users` 
    },
    { 
      key: "payments", 
  ...
  const ADMIN_NAV: NavItem[] = [
    { 
      ...
      label: "Overview",
      icon: { type: "ion", name: "grid-outline" }, 
      path: `${base}/{branchId}/overview/Overview` 
    },
    { 
      key: "branch", 
      match: "institution", 
      label: "Branch",
      icon: { type: "ion", name: "git-branch" }, 
      path: `${base}/institution/${institutionId}/{branchId}` 
    },
    { 
      key: "profile", 
      match: "profile", 
